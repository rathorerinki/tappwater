...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    // { path: '', component: LoginComponent },
    {
      ...
      path: 'tap-water-quality-report/:id/:postcode',
      component: _report_report_component__WEBPACK_IMPORTED_MODULE_5__["ReportComponent"]
    }, {
      path: 'check/:id/:postcode',
      component: _check_check_component__WEBPACK_IMPORTED_MODULE_6__["CheckComponent"]
    ...
    //spanish
    {
      path: 'calidad-del-agua/:id/:postcode',
      component: _report_report_component__WEBPACK_IMPORTED_MODULE_5__["ReportComponent"]
    }, {
      path: 'componentes-de-agua/:id/:postcode',
      component: _check_check_component__WEBPACK_IMPORTED_MODULE_6__["CheckComponent"]
    }];
    ...
    function () {
      ...
      _createClass(CheckComponent, [{
        ...
        value: function display() {
          ...
          this.apiservices.postdata("post_code", this.data).subscribe(function (res) {
            console.log(res);
            _this2.data['utlity_enter'] = res['data']['utlity_enter'];
            _this2.data['province'] = res['data']['province'];
            _this2.data['city'] = res['data']['city'][0]['city'];
            _this2.data['country'] = res['data']['country'];
            _this2.data['averageDataRange'] = res['data']['averageDataRange'];
            console.log("this.data['averageDataRange']", _this2.data['averageDataRange']);
          });
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["forkJoin"])(requestArray).subscribe(function (results) {
            ...
            if (!(results[0] && results[0].constructor === Array && Object.keys(results[0]).length === 0)) {
              for (var j = 0; j < _this2.results[0].length; j++) {
                ...
                _this2.results[0][j]['Filtering'] = parseFloat(_this2.results[0][j]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[1] && results[1].constructor === Array && Object.keys(results[1]).length === 0)) {
              for (var _j = 0; _j < _this2.results[1].length; _j++) {
                ...
                if (_this2.results[1][_j]['Substance'] != "Microplastics") {
                  _this2.results[1][_j]['Filtering'] = parseFloat(_this2.results[1][_j]['Filtering']).toFixed(2);
                } else {
                  _this2.results[1][_j]['Filtering'] = 'Z';
                }
              }
            ...
            if (!(results[2] && results[2].constructor === Array && Object.keys(results[2]).length === 0)) {
              for (var _j2 = 0; _j2 < _this2.results[2].length; _j2++) {
                // console.log(this.results[0][j]);
                _this2.results[2][_j2]['Filtering'] = parseFloat(_this2.results[2][_j2]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[3] && results[3].constructor === Array && Object.keys(results[3]).length === 0)) {
              for (var _j3 = 0; _j3 < _this2.results[3].length; _j3++) {
                // console.log(this.results[0][j]);
                _this2.results[3][_j3]['Filtering'] = parseFloat(_this2.results[3][_j3]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[4] && results[4].constructor === Array && Object.keys(results[4]).length === 0)) {
              for (var _j4 = 0; _j4 < _this2.results[4].length; _j4++) {
                // console.log(this.results[0][j]);
                _this2.results[4][_j4]['Filtering'] = parseFloat(_this2.results[4][_j4]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[5] && results[5].constructor === Array && Object.keys(results[5]).length === 0)) {
              for (var _j5 = 0; _j5 < _this2.results[5].length; _j5++) {
                _this2.results[5][_j5]['Filtering'] = parseFloat(_this2.results[5][_j5]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[6] && results[6].constructor === Array && Object.keys(results[6]).length === 0)) {
              for (var _j6 = 0; _j6 < _this2.results[6].length; _j6++) {
                _this2.results[6][_j6]['Filtering'] = parseFloat(_this2.results[6][_j6]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[7] && results[7].constructor === Array && Object.keys(results[7]).length === 0)) {
              for (var _j7 = 0; _j7 < _this2.results[7].length; _j7++) {
                _this2.results[7][_j7]['Filtering'] = parseFloat(_this2.results[7][_j7]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[8] && results[8].constructor === Array && Object.keys(results[8]).length === 0)) {
              for (var _j8 = 0; _j8 < _this2.results[8].length; _j8++) {
                _this2.results[8][_j8]['Filtering'] = parseFloat(_this2.results[8][_j8]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[9] && results[9].constructor === Array && Object.keys(results[9]).length === 0)) {
              for (var _j9 = 0; _j9 < _this2.results[9].length; _j9++) {
                _this2.results[9][_j9]['Filtering'] = parseFloat(_this2.results[9][_j9]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[10] && results[10].constructor === Array && Object.keys(results[10]).length === 0)) {
              for (var _j10 = 0; _j10 < _this2.results[10].length; _j10++) {
                _this2.results[10][_j10]['Filtering'] = parseFloat(_this2.results[10][_j10]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[11] && results[11].constructor === Array && Object.keys(results[11]).length === 0)) {
              for (var _j11 = 0; _j11 < _this2.results[11].length; _j11++) {
                _this2.results[11][_j11]['Filtering'] = parseFloat(_this2.results[11][_j11]['Filtering']).toFixed(2);
              }
            ...
            if (!(results[12] && results[12].constructor === Array && Object.keys(results[12]).length === 0)) {
              for (var _j12 = 0; _j12 < _this2.results[12].length; _j12++) {
                _this2.results[12][_j12]['Filtering'] = parseFloat(_this2.results[12][_j12]['Filtering']).toFixed(2);
              }
  ...
  function srcAppCreateprofileCreateprofileComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "::ng-deep .row {\r\n    margin-right: 0px; \r\n    margin-left: 0px;\r\n}\r\n\r\n\r\n\r\n\r\n\r\nhtml {\r\n  -webkit-text-size-adjust: none\r\n}\r\n\r\n\r\n\r\n\r\n\r\n::ng-deep .mat-form-field-flex {\r\n  display: -webkit-inline-box;\r\n  display: inline-flex;\r\n  -webkit-box-align: baseline;\r\n          align-items: baseline;\r\n  box-sizing: border-box;\r\n  width: 90% !important;\r\n}\r\n\r\n\r\n\r\n\r\n\r\n::ng-deep .mat-form-field-underline {\r\n  position: absolute;\r\n  width: 0% !important;\r\n  pointer-events: none;\r\n  -webkit-transform: scaleY(1.0001);\r\n          transform: scaleY(1.0001);\r\n  border-bottom: none;\r\n}\r\n\r\n\r\n\r\n\r\n\r\n/* ----------- Non-Retina Screens ----------- */\r\n\r\n\r\n\r\n\r\n\r\n@media screen \r\n  and (min-width: 1200px) \r\n  and (max-width: 1600px) \r\n   { \r\n\r\n    img.select_img {\r\n      width: 40px;\r\n      margin-right: 10px;\r\n  }\r\n\r\n  .mat-field{\r\n    background-color: tomato !important;\r\n    display: inline-block !important;\r\n    position: relative !important;\r\n    text-align: left !important;\r\n    width: 354px !important;\r\n    background: white !important;\r\n    border: 1px solid white !important;\r\n    border-radius: 11px !important;\r\n    margin-bottom: 16px !important;\r\n    height: 64px !important;\r\n    box-shadow: 1px 1px 1px 1px lightgrey !important;\r\n    font-size: 20px !important;\r\n    padding-left: 0px !important;\r\n    }\r\n/* //start */\r\n.select_language{\r\n\r\n}\r\n\r\nmat-form-field.mat-form-field.ng-tns-c3-0.mat-primary.mat-form-field-type-mat-select.mat-form-field-appearance-legacy.mat-form-field-can-float.mat-form-field-hide-placeholder {\r\n  width: 354px;\r\n  background:white;\r\n  height: 64px;\r\n  /* margin-top: -14px; */\r\n  border: 1px solid lightgrey;\r\n  border-radius: 10px;\r\n  font-size:20px;\r\n  margin-bottom: 12px;\r\n  box-shadow: 1px 1px 1px 1px lightgrey;\r\n  padding-left: 0px !important;\r\n\r\n}\r\n.country_select ::ng-deep span.ng-tns-c4-1.ng-star-inserted {\r\n  line-height: 1.4;\r\n  margin-left: -15px;\r\n}\r\n::ng-deep .mat-form-field-infix {\r\n    display: block;\r\n    position: relative;\r\n    -webkit-box-flex: 1;\r\n            flex: auto;\r\n    min-width: 0;\r\n    /* top: 10px; */\r\n    width: 180px;\r\n    left: 20px;\r\n    /* background: white; */\r\n    line-height: 1;\r\n}\r\n\r\n\r\n.mat-form-field-infix1{\r\n  display: block;\r\n  position: relative;\r\n  -webkit-box-flex: 1;\r\n          flex: auto;\r\n  min-width: 0;\r\n  /* top: 10px; */\r\n  width: 180px;\r\n  left: 20px;\r\n  /* background: white; */\r\n  line-height: 1;\r\n}\r\nimg.select_img.position_img.ng-star-inserted {\r\n  position: absolute;\r\n  top: 174px;\r\n  left: 10px;\r\n}\r\n.select_select {\r\n  width: 354px;\r\n  height: 64px;\r\n  margin-bottom: 10px;\r\n  border-radius: 10px;\r\n  border: 1px solid white;\r\n  box-shadow: 1px 1px 1px 1px lightgrey;\r\n  margin-top: -4px;\r\n  font-size: 20px;\r\n  padding-left: 11px;\r\n  background-color: white;\r\n}\r\n.select_select select{\r\n  border: 1px solid white;\r\n  margin-top: 18px;\r\n  width: 94%;\r\n  color: black;\r\n  outline: none;\r\n}\r\n::ng-deep .mat-select-value-text {\r\n    white-space: nowrap;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n    padding-left: 29px;\r\n}\r\n\r\n::ng-deep .mat-select-value-text1 {\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  padding-left: 29px;\r\n}\r\nlabel {\r\n  display: inline-block;\r\n  max-width: 100%;\r\n  margin-bottom: 5px;\r\n  font-weight: 700;\r\n  /* color: white; */\r\n  background: bottom;\r\n  margin-top: 19px;\r\n  line-height: 2.5;\r\n  margin-left: 20px;\r\n  /* width: 180px; */\r\n}\r\n.select{\r\n    margin-top: 11px;\r\n    height: 64px;\r\n    width: 354px;\r\n    border-radius: 10px;\r\n    /* position: absolute; */\r\n    background: white;\r\n    border: 1px solid white;\r\n    height:64px;\r\n    width:354px;\r\n    box-shadow: 1px 1px 1px 1px lightgrey;\r\n    color: #bcbcbc;\r\n    padding-left:10px;\r\n    font-size:20px;\r\n \r\n}\r\n\r\n.select1{\r\n  margin-top: -21px;\r\n  height: 64px;\r\n  width: 354px;\r\n  border-radius: 10px;\r\n  background: white;\r\n  border: 1px solid white;\r\n\r\n  margin-bottom: 11px;\r\n  box-shadow: 1px 1px 1px 1px lightgrey;\r\n  color: #bcbcbc;\r\n  /* padding-left: 10px; */\r\n  font-size: 20px;\r\n}\r\n\r\n\r\n.mat-toolbar {\r\n  background: white;\r\n  color: rgba(0, 0, 0, 0.87);\r\n}\r\n\r\n\r\n.fa, .fab, .fal, .far, .fas {\r\n  -moz-osx-font-smoothing: grayscale;\r\n  -webkit-font-smoothing: antialiased;\r\n  /* display: inline-block; */\r\n  font-style: normal;\r\n  font-variant: normal;\r\n  text-rendering: auto;\r\n  font-size: 27px;\r\n  line-height: 1.9;\r\n  color: white;\r\n  margin-right:10px;\r\n}\r\n\r\n.top_icons {\r\n/* width:50% !important; */\r\n}\r\n.center{\r\ntext-align: center;\r\nposition: absolute;\r\ntop: 0;\r\nleft: 40%;\r\nline-height: 0.7;\r\ncolor: white;\r\nfont-size: 15px !important;\r\n}\r\nselect.classic {\r\n   /* top: 32px; */\r\n   background-image: linear-gradient(45deg, transparent 50%, #e8e8f1 50%), linear-gradient(135deg, #ededf3 50%, transparent 50%), linear-gradient(to right, #222324, #2f3030);\r\n   background-position: calc(100% - 23px) calc(1em + 2px), calc(100% - 15px) calc(1em + 2px), 100% 47px;\r\n   background-size: 8px 8px, 8px 8px, 2.8em 2.8em;\r\n   background-repeat: no-repeat;  \r\n}\r\n\r\nselect.mat-input-element {\r\n  font: normal !;\r\n    -moz-appearance: none;\r\n    -webkit-appearance: none;\r\n    position: relative;\r\n    background-color: #003955;\r\n    color: white;\r\n    display: -webkit-inline-box;\r\n    display: inline-flex;\r\n    box-sizing: border-box;\r\n    /* font-size: 19px; */\r\n    padding-top: 7px !important;\r\n    /* padding-top: 1em; */\r\n    top: -1em;\r\n    margin-bottom: -1em;\r\n}\r\n.h1, .h2, .h3, .h4, .h5, .h6, h1, h2, h3, h4, h5, h6 {\r\n  font-family: inherit;\r\n  font-weight: 500;\r\n  line-height: 0.4;\r\n  color: inherit;\r\n}\r\nheader {\r\n    height: 58px;\r\n    width: 100%;\r\n    background-color: #003955;\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n}\r\n.mat-toolbar-row, .mat-toolbar-single-row {\r\n  /* height: 226px; */\r\n  /* margin-bottom: -35px; */\r\n}\r\n\r\n.left {\r\n    width: 50%;\r\n}\r\n.right {\r\n    width: 48%;\r\n}\r\n\r\n  \r\n  .topnav {\r\n    overflow: hidden;\r\n  \r\n  }\r\n  \r\n  .topnav a {\r\n    float: left;\r\n    display: block;\r\n    color: #333 !important;\r\n    text-align: center;\r\n    padding: 14px 20px;\r\n    text-decoration: none;\r\n    font-size: 21px;\r\n  }\r\n  \r\n  .topnav a:hover {\r\n    background-color: #ddd;\r\n    color: black;\r\n  }\r\n  \r\n  .topnav a.active {\r\n    background-color: white;\r\n    color: black;\r\n  }\r\n  \r\n  .topnav .icon {\r\n    display: none;\r\n  }\r\n    /* //end */\r\n    .circle{\r\n   \r\n        height:607px;\r\n        width:607px;\r\n        background-color: #e6f7f7;\r\n        /* opacity: 20%; */\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    /* Chrome, Safari, Edge, Opera */\r\n    input::-webkit-outer-spin-button,\r\n    input::-webkit-inner-spin-button {\r\n      -webkit-appearance: none;\r\n      margin: 0;\r\n    }\r\n    \r\n    /* Firefox */\r\n    input[type=number] {\r\n      -moz-appearance:textfield;\r\n    }\r\n    .margin_top{\r\n    \r\n        /* margin-top:116px; */\r\n    \r\n    }\r\n    .top_square{\r\n    \r\n        height: 130px;\r\n        width: 130px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #fdd9c0;\r\n        left: 190px;\r\n        position: absolute;\r\n        top: -86px;\r\n        z-index: 1;\r\n    }\r\n    \r\n    .right_square{\r\n    \r\n        height: 32px;\r\n        width: 32px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: teal;\r\n        left: 516px;\r\n        position: absolute;\r\n        top: -8px;\r\n    }\r\n    .bottom_right_circle{\r\n    \r\n        height: 120px;\r\n        width: 120px;\r\n        left: 472px;\r\n        position: absolute;\r\n        top: 500px;\r\n        background-color: #c7e8f2;\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    .bottom_left_square{\r\n    \r\n        height: 64px;\r\n        width: 64px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #e6f7f7;\r\n        left: 43px;\r\n        position: absolute;\r\n       \r\n        top: 682px;\r\n    }\r\n    \r\n    .margin_top h1{\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n        top: 152px;\r\n        position: absolute;\r\n        line-height: 1;\r\n        left: 168px;\r\n        text-align: center;\r\n        color: #003955;\r\n        \r\n    }\r\n    .margin_top p{\r\n    \r\n        font-size: 19px;\r\n    top: 270px;\r\n    position: absolute;\r\n    left: 112px;\r\n    text-align: center;\r\n    letter-spacing: 1px;\r\n    right: 69px;\r\n    color: #003955;\r\n    font-family: serif;\r\n    }\r\n\r\n    .margin_top .form{\r\n        position: absolute;\r\n        top: 412px;\r\n        left: 139px;\r\n    }\r\n    .margin_top .form input{\r\n        height: 64px;\r\n        width: 354px;\r\n        border-radius: 10px;\r\n        /* position: absolute; */\r\n        border: 1px solid white;\r\n        height:64px;\r\n        width:354px;\r\n        font-size: 20px;\r\n        padding-left: 11px;\r\n        box-shadow: 1px 1px 1px 1px lightgrey;\r\n    }\r\n    .margin_top .form input::-webkit-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    .margin_top .form input::-moz-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    .margin_top .form input::-ms-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    .margin_top .form input::placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    \r\n      .margin_top .form input::value {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    \r\n      .button_reset{\r\n        color: white;\r\n        height:64px;\r\n        font-size:20px;\r\n        width:354px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 24px;\r\n        cursor: pointer;\r\n        outline:none;\r\n\r\n    \r\n    }\r\n\r\n    span {\r\n        color: #003955;\r\n        /* font-size: :9pt; */\r\n        font-size: 16px;\r\n        margin-left:18px;\r\n        font-family: serif;\r\n        text-align: center;\r\n    }\r\n    .top{\r\n/* margin-top:90px; */\r\n\r\n    margin-top: -84px;\r\n    margin-left: 67px;\r\n    text-align:center;\r\n    }\r\n    /* input[type=text]::-ms-clear {\r\n      color:red\r\n    } */\r\n}\r\n\r\n\r\n\r\n\r\n\r\n@media screen \r\n  and (min-device-width: 1200px) \r\n  and (max-device-width: 1600px) \r\n  and (-webkit-min-device-pixel-ratio: 2)\r\n  and (-webkit-min-device-pixel-ratio: 2), screen \r\n  and (min-device-width: 1200px) \r\n  and (max-device-width: 1600px) \r\n  and (-webkit-min-device-pixel-ratio: 2)\r\n  and (min-resolution: 192dpi) { \r\n\r\n\r\n\r\n    .mat-field{\r\n      background-color: tomato !important;\r\n      display: inline-block !important;\r\n      position: relative !important;\r\n      text-align: left !important;\r\n      width: 354px !important;\r\n      background: white !important;\r\n      border: 1px solid white !important;\r\n      border-radius: 11px !important;\r\n      margin-bottom: 16px !important;\r\n      height: 64px !important;\r\n      box-shadow: 1px 1px 1px 1px lightgrey !important;\r\n      font-size: 20px !important;\r\n      padding-left: 0px !important;\r\n      }\r\n\r\n        span {\r\n        color: #003955;\r\n        /* font-size: :9pt; */\r\n        font-size: 12px;\r\n        font-family: serif;\r\n        text-align: center;\r\n        }\r\n        .top{\r\n        margin-top:90px;\r\n        text-align:center;\r\n        }\r\n    .circle{\r\n   \r\n        height:607px;\r\n        width:607px;\r\n        background-color: #e6f7f7;\r\n        /* opacity: 20%; */\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    /* Chrome, Safari, Edge, Opera */\r\n    input::-webkit-outer-spin-button,\r\n    input::-webkit-inner-spin-button {\r\n      -webkit-appearance: none;\r\n      margin: 0;\r\n    }\r\n    \r\n    /* Firefox */\r\n    input[type=number] {\r\n      -moz-appearance:textfield;\r\n    }\r\n    .margin_top{\r\n    \r\n        /* margin-top:116px; */\r\n    \r\n    }\r\n    .top_square{\r\n    \r\n        height: 130px;\r\n        width: 130px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #fdd9c0;\r\n        left: 190px;\r\n        position: absolute;\r\n        top: -86px;\r\n        z-index: 1;\r\n    }\r\n    \r\n    .right_square{\r\n    \r\n        height: 32px;\r\n        width: 32px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: teal;\r\n        left: 516px;\r\n        position: absolute;\r\n        top: -8px;\r\n    }\r\n    .bottom_right_circle{\r\n    \r\n        height: 120px;\r\n        width: 120px;\r\n        left: 472px;\r\n        position: absolute;\r\n        top: 500px;\r\n        background-color: #c7e8f2;\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    .bottom_left_square{\r\n    \r\n        height: 64px;\r\n        width: 64px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #e6f7f7;\r\n        left: 43px;\r\n        position: absolute;\r\n       \r\n        top: 682px;\r\n    }\r\n    \r\n    .margin_top h1{\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n        top: 140px;\r\n        position: absolute;\r\n        left: 172px;\r\n        text-align: center;\r\n        color: #003955;\r\n        \r\n    }\r\n    .margin_top p{\r\n    \r\n        font-size: 19px;\r\n    top: 270px;\r\n    position: absolute;\r\n    left: 112px;\r\n    text-align: center;\r\n    letter-spacing: 1px;\r\n    right: 69px;\r\n    color: #003955;\r\n    font-family: serif;\r\n    }\r\n    .margin_top .form{\r\n        position: absolute;\r\n        top: 411px;\r\n        left: 139px;\r\n    }\r\n    .margin_top .form input{\r\n        height: 64px;\r\n        width: 354px;\r\n        border-radius: 10px;\r\n        /* position: absolute; */\r\n        border: 1px solid white;\r\n        height:64px;\r\n        width:354px;\r\n        box-shadow: 1px 1px 1px 1px lightgrey;\r\n    }\r\n    .margin_top .form input::-webkit-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    .margin_top .form input::-moz-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    .margin_top .form input::-ms-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    .margin_top .form input::placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    \r\n      .margin_top .form input::value {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:20px;\r\n      }\r\n    \r\n      .button_reset{\r\n        color: white;\r\n        height:64px;\r\n        font-size:20px;\r\n        width:354px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 24px;\r\n        outline:none;\r\n\r\n    \r\n    }\r\n}\r\n\r\n\r\n\r\n\r\n\r\n@media only screen and (max-width: 600px) {\r\n\r\n  \r\n  .mat-field{\r\n    width: 266px;\r\n    height: 54px;\r\n    margin-top: -34px;\r\n    border: 1px solid lightgrey;\r\n    border-radius: 10px;\r\n    margin-bottom: 12px;\r\n    box-shadow: 1px 1px 1px 1px lightgrey;\r\n\r\n    }\r\n.select_select{\r\n  box-shadow: 1px 1px 1px 1px lightgrey;\r\n  margin: auto;\r\n  border-radius: 10px;\r\n  height: 54px;\r\n  width: 266px;\r\n  background-color: white;\r\n  margin-top: -34px;\r\n  margin-bottom: 12px;\r\n\r\n}\r\n\r\nmat-form-field.mat-form-field.ng-tns-c3-0.mat-primary.mat-form-field-type-mat-select.mat-form-field-appearance-legacy.mat-form-field-can-float.mat-form-field-hide-placeholder {\r\n  width: 266px;\r\n  height: 54px;\r\n  margin-top: -34px;\r\n  border: 1px solid lightgrey;\r\n  border-radius: 10px;\r\n  margin-bottom: 12px;\r\n  box-shadow: 1px 1px 1px 1px lightgrey;\r\n}\r\n\r\n\r\n.country_select ::ng-deep .mat-select-value {\r\n  display: table-cell;\r\n  max-width: 0;\r\n  width: 100%;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n  padding-left: 0px !important;\r\n  line-height: 1.4;\r\n}\r\n\r\n.country_select ::ng-deep span.ng-tns-c4-1.ng-star-inserted {\r\n  line-height: 1.4;\r\n  margin-left: 10px;\r\n}\r\n.select_select select{\r\n  border:1px solid white;\r\n  outline:none;\r\n  margin-top: 16px;\r\n  width: 89%;\r\n  background-color: white;\r\n  background-color: rgb(255,255,255); \r\n  background-color: rgba(255,255,255,0.5,0.543); \r\n  /* background-color:rgba(128, 128, 128, 0.543); */\r\n}\r\n.select ::ng-deep .mat-select-value {\r\n    display: table-cell;\r\n    max-width: 0;\r\n    width: 100%;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n    white-space: nowrap;\r\n    padding-left: 72px !important;\r\n    line-height: 1.4;\r\n}\r\n  img.select_img {\r\n    width: 40px;\r\n    height: 24px;\r\n    margin-right: 12px;\r\n}\r\n  img.select_img.position_img.ng-star-inserted{\r\n    position: absolute;\r\n    top: 131px;\r\n    left: 16%;\r\n}\r\n::ng-deep span.ng-tns-c4-1.ng-star-inserted {\r\n  /* margin-left: 34px; */\r\n  line-height: 1.4;\r\n  margin-left: 12%;\r\n}\r\n\r\n  .select{\r\n\r\n    border-radius: 10px;\r\n    border: 1px solid lightgrey;\r\n    height: 54px;\r\n    width: 266px;\r\n    -webkit-appearance: none;\r\n\r\n    margin-top: 12px;\r\n    border-radius: 10px;\r\n    background: white;\r\n    box-shadow: 1px 1px 1px 1px lightgrey;\r\n    color: #bcbcbc;\r\n \r\n}\r\n    .container {\r\n        padding-right: 0px;\r\n        padding-left: 0px;\r\n        margin-right: auto;\r\n        margin-left: auto;\r\n    }\r\n           \r\n    .col-lg-2, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6, .col-lg-7, .col-lg-8, .col-lg-9, .col-md-1, .col-md-10, .col-md-11, .col-md-12, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, .col-md-7, .col-md-8, .col-md-9, .col-sm-1, .col-sm-10, .col-sm-11, .col-sm-12, .col-sm-2, .col-sm-3, .col-sm-4, .col-sm-5, .col-sm-6, .col-sm-7, .col-sm-8, .col-sm-9, .col-xs-1, .col-xs-10, .col-xs-11, .col-xs-12, .col-xs-2, .col-xs-3, .col-xs-4, .col-xs-5, .col-xs-6, .col-xs-7, .col-xs-8, .col-xs-9 \r\n    \r\n    {\r\n        position: relative;\r\n        min-height: 1px;\r\n        padding-right: 0px;\r\n        padding-left: 0px;\r\n    \r\n    }\r\n        /* Chrome, Safari, Edge, Opera */\r\n        input::-webkit-outer-spin-button,\r\n        input::-webkit-inner-spin-button {\r\n          -webkit-appearance: none;\r\n          margin: 0;\r\n        }\r\n        \r\n        /* Firefox */\r\n        input[type=number] {\r\n          -moz-appearance:textfield;\r\n        }\r\n    .col-xs-12 {\r\n        width: auto;\r\n        text-align: center;\r\n    }\r\n    \r\n    .top {\r\n        margin-top: 228px;\r\n        text-align: center;\r\n        color: #003955;\r\n        font-size: 11px;\r\n        margin-left: 6%;\r\n        margin-right: 6%\r\n          }\r\n    img {\r\n        /* width: 405px;\r\n        height: 544px; */\r\n        width: 92%;\r\n        height: 470px;\r\n        margin-left: 4%;\r\n        margin-right: 4%;\r\n        \r\n    }\r\n    \r\n    .app-topbar {\r\n        display: none !important;\r\n    }\r\n\r\n    \r\n    .circle{\r\n    \r\n        height:607px;\r\n        width:607px;\r\n        background-color: #e6f7f7;\r\n        /* opacity: 20%; */\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    /* Chrome, Safari, Edge, Opera */\r\n    input::-webkit-outer-spin-button,\r\n    input::-webkit-inner-spin-button {\r\n      -webkit-appearance: none;\r\n      margin: 0;\r\n    }\r\n    \r\n    /* Firefox */\r\n    input[type=number] {\r\n      -moz-appearance:textfield;\r\n    }\r\n    .margin_top{\r\n    \r\n        /* margin-top:116px; */\r\n    \r\n    }\r\n    .top_square{\r\n    \r\n        height: 130px;\r\n        width: 130px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #fdd9c0;\r\n        left: 190px;\r\n        position: absolute;\r\n        top: -86px;\r\n        z-index: 1;\r\n    }\r\n    \r\n    .right_square{\r\n    \r\n        height: 32px;\r\n        width: 32px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: teal;\r\n        left: 516px;\r\n        position: absolute;\r\n        top: -8px;\r\n    }\r\n    .bottom_right_circle{\r\n    \r\n        height: 120px;\r\n        width: 120px;\r\n        left: 472px;\r\n        position: absolute;\r\n        top: 500px;\r\n        background-color: #c7e8f2;\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    .bottom_left_square{\r\n    \r\n        height: 64px;\r\n        width: 64px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #e6f7f7;\r\n        left: 43px;\r\n        position: absolute;\r\n       \r\n        top: 682px;\r\n    }\r\n    \r\n    .margin_top h1{\r\n        /* font-family: Ubuntu;\r\n        font-weight: 600;\r\n        top: 181px;\r\n        position: absolute;\r\n        left: 64px;\r\n        font-size: 35px;\r\n        text-align: center;\r\n        color: #003955; */\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n        top: 90px;\r\n        position: absolute;\r\n        left: 20%;\r\n        font-size: 28px;\r\n        text-align: center;\r\n        color: #003955;\r\n        \r\n    }\r\n    .margin_top p{\r\n        /* font-size: 19px;\r\n        top: 339px;\r\n        position: absolute;\r\n        left: 76px;\r\n        text-align: center;\r\n        letter-spacing: 1px;\r\n        right: 69px;\r\n        color: #003955;\r\n        font-family: serif; */\r\n    font-size: 17px;\r\n    top: 200px;\r\n    position: absolute;\r\n    left: 34px;\r\n    text-align: center;\r\n    letter-spacing: 1px;\r\n    right: 33px;\r\n    color: #003955;\r\n    font-family: serif;\r\n\r\n    }\r\n    .margin_top .form{\r\n        /* position: absolute;\r\n        top: 544px;\r\n        left: 52px; */\r\n        position: absolute;\r\n        top: 442px;\r\n        /* left: 26px */\r\n    \r\n    }\r\n    .margin_top .form input{\r\n        border-radius: 10px;\r\n        border: 1px solid lightgrey;\r\n        height: 54px;\r\n        padding-left: 12px;\r\n        width: 266px;\r\n        box-shadow: 1px 1px 1px 1px lightgrey;\r\n        -webkit-appearance : none;\r\n    \r\n    \r\n    }\r\n    /* input[type=\"text\"] {\r\n        -webkit-appearance : none;\r\n        border-radius      : 0;\r\n    } */\r\n    .margin_top .form input::-webkit-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    .margin_top .form input::-moz-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    .margin_top .form input::-ms-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    .margin_top .form input::placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    \r\n\r\n      \r\n      .margin_top .form input::value {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    \r\n      .button_reset{\r\n        color: white;\r\n        /* height:64px; */\r\n        font-size:16px;\r\n        height: 54px;\r\n        width: 266px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 24px;\r\n    \r\n    }\r\n    input::-webkit-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-moz-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-ms-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::placeholder {\r\n        overflow: visible;\r\n      }\r\n\r\n\r\n}\r\n\r\n\r\n\r\n\r\n\r\n@media (min-width: 768px) and (max-width: 1024px) {\r\n  \r\n\r\n  ::ng-deep .mat-select-value {\r\n    display: table-cell;\r\n    max-width: 0;\r\n    width: 100%;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n    white-space: nowrap;\r\n    padding-left: 62px !important;\r\n    line-height: 1.4;\r\n}\r\n  img.select_img {\r\n    width: 40px;\r\n    height: 24px;\r\n    margin-right: 12px;\r\n}\r\n  img.select_img.position_img.ng-star-inserted{\r\n    position: absolute;\r\n    top: 73px;\r\n    left: 16%;\r\n\r\n}\r\n::ng-deep mat-option#mat-option-1 img {\r\n  margin-top: 0%;\r\n}\r\n\r\n::ng-deep mat-option#mat-option-0 img {\r\n  margin-top: 0%;\r\n}\r\n::ng-deep span.ng-tns-c4-1.ng-star-inserted {\r\n  /* margin-left: 34px; */\r\n  line-height: 1.4;\r\n}\r\n\r\n  .select{\r\n    border-radius: 10px;\r\n    border: 1px solid lightgrey;\r\n    height: 64px;\r\n    width: 386px;\r\n    -webkit-appearance: none;\r\n    margin-top: 22px;\r\n    border-radius: 10px;\r\n    background: white;\r\n    box-shadow: 1px 1px 1px 1px lightgrey;\r\n    color: #bcbcbc;\r\n \r\n}\r\n    .container {\r\n        padding-right: 0px;\r\n        padding-left: 0px;\r\n        margin-right: auto;\r\n        margin-left: auto;\r\n    }\r\n           \r\n    /* .col-lg-2, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6, .col-lg-7, .col-lg-8, .col-lg-9, .col-md-1, .col-md-10, .col-md-11, .col-md-12, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, .col-md-7, .col-md-8, .col-md-9, .col-sm-1, .col-sm-10, .col-sm-11, .col-sm-12, .col-sm-2, .col-sm-3, .col-sm-4, .col-sm-5, .col-sm-6, .col-sm-7, .col-sm-8, .col-sm-9, .col-xs-1, .col-xs-10, .col-xs-11, .col-xs-12, .col-xs-2, .col-xs-3, .col-xs-4, .col-xs-5, .col-xs-6, .col-xs-7, .col-xs-8, .col-xs-9 \r\n    \r\n    {\r\n        position: relative;\r\n        min-height: 1px;\r\n        padding-right: 0px;\r\n        padding-left: 0px;\r\n    \r\n    } */\r\n        /* Chrome, Safari, Edge, Opera */\r\n        input::-webkit-outer-spin-button,\r\n        input::-webkit-inner-spin-button {\r\n          -webkit-appearance: none;\r\n          margin: 0;\r\n        }\r\n        \r\n        /* Firefox */\r\n        input[type=number] {\r\n          -moz-appearance:textfield;\r\n        }\r\n    .col-xs-12 {\r\n        width: auto;\r\n        text-align: center;\r\n    }\r\n    \r\n    .top {\r\n        margin-top: 76px;\r\n        text-align: center;\r\n        color: #003955;\r\n        font-size: 11px;\r\n        margin-left: 1%;\r\n        margin-right: 1%;\r\n    }\r\n    img {\r\n        /* width: 405px;\r\n        height: 544px; */\r\n        width: 92%;\r\n        height: 100%;\r\n        margin-left: 4%;\r\n        margin-right: 4%;\r\n        margin-top: 5%;\r\n        text-align:center\r\n        \r\n    }\r\n    \r\n    .app-topbar {\r\n        display: none !important;\r\n    }\r\n\r\n    \r\n    .circle{\r\n    \r\n        height:607px;\r\n        width:607px;\r\n        background-color: #e6f7f7;\r\n        /* opacity: 20%; */\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    /* Chrome, Safari, Edge, Opera */\r\n    input::-webkit-outer-spin-button,\r\n    input::-webkit-inner-spin-button {\r\n      -webkit-appearance: none;\r\n      margin: 0;\r\n    }\r\n    \r\n    /* Firefox */\r\n    input[type=number] {\r\n      -moz-appearance:textfield;\r\n    }\r\n    .margin_top{\r\n    \r\n        /* margin-top:116px; */\r\n        margin-left: 8%;\r\n    \r\n    }\r\n    .top_square{\r\n    \r\n        height: 130px;\r\n        width: 130px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #fdd9c0;\r\n        left: 190px;\r\n        position: absolute;\r\n        top: -86px;\r\n        z-index: 1;\r\n    }\r\n    \r\n    .right_square{\r\n    \r\n        height: 32px;\r\n        width: 32px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: teal;\r\n        left: 516px;\r\n        position: absolute;\r\n        top: -8px;\r\n    }\r\n    .bottom_right_circle{\r\n    \r\n        height: 120px;\r\n        width: 120px;\r\n        left: 472px;\r\n        position: absolute;\r\n        top: 500px;\r\n        background-color: #c7e8f2;\r\n        border-radius: 50%;\r\n    }\r\n    \r\n    .bottom_left_square{\r\n    \r\n        height: 64px;\r\n        width: 64px;\r\n        -webkit-transform: rotate(-46deg);\r\n        transform: rotate(-46deg);\r\n        background: #e6f7f7;\r\n        left: 43px;\r\n        position: absolute;       \r\n        top: 682px;\r\n    }\r\n    \r\n    .margin_top h1{\r\n      font-family: Ubuntu;\r\n      font-weight: 600;\r\n      top: 141px;\r\n      position: absolute;\r\n      left: 31%;\r\n      font-size: 28px;\r\n      text-align: center;\r\n      color: #003955;\r\n        \r\n    }\r\n    .margin_top p{\r\n      font-size: 17px;\r\n      top: 257px;\r\n      position: absolute;\r\n      left: 69px;\r\n      text-align: center;\r\n      letter-spacing: 1px;\r\n      right: 87px;\r\n      color: #003955;\r\n      font-family: serif;\r\n\r\n    }\r\n    .margin_top .form{\r\n        text-align: center;\r\n        position: absolute;\r\n        /* left: 28%; */\r\n        top: 400px;\r\n    \r\n    }\r\n    .margin_top .form input{\r\n        border-radius: 10px;\r\n        border: 1px solid lightgrey;\r\n        height: 64px;\r\n        width: 386px;\r\n        box-shadow: 1px 1px 1px 1px lightgrey;\r\n        -webkit-appearance : none;\r\n    \r\n    \r\n    }\r\n    /* input[type=\"text\"] {\r\n        -webkit-appearance : none;\r\n        border-radius      : 0;\r\n    } */\r\n    .margin_top .form input::-webkit-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    .margin_top .form input::-moz-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    .margin_top .form input::-ms-input-placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    .margin_top .form input::placeholder {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    \r\n\r\n      \r\n      .margin_top .form input::value {\r\n        color: #bcbcbc;\r\n        padding-left:10px;\r\n        font-size:18px;\r\n        overflow: visible;\r\n      }\r\n    \r\n      .button_reset{\r\n        color: white;\r\n        /* height:64px; */\r\n        font-size:20px;\r\n        height: 64px;\r\n        width: 386px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 24px;\r\n        outline:none;\r\n    \r\n    }\r\n    input::-webkit-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-moz-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-ms-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::placeholder {\r\n        overflow: visible;\r\n      }\r\n  \r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
        ...
        value: function okay() {
          ...
          this.apiservices.postdata("post_code", this.data).subscribe(function (data) {
            ...
            if (data['status'] == "false") {
              ...
              _this3.router.navigate([_this3.page_redirect, data['data']['_id'], _this3.data['postcode']]);
            }
  ...
  function srcAppReportReportComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "th.mat-header-cell.cdk-column-Substance.mat-column-Substance {\r\n    width: 28%;\r\n    padding: 20px;\r\n    text-align: center;\r\n    width: 25%;\r\n    text-align: center;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-right: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-top: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\ntr.mat-row.border {\r\n    border-bottom: 1px solid #8080804a;\r\n}\r\n\r\n::ng-deep mat-row, td.mat-cell {\r\n    border-top-color: #00808085;\r\n    font-size: 16px;\r\n    line-height: 2.7;\r\n    font-family: Ubuntu;\r\n    color: #2b5d6f;\r\n    text-align: center;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\n::ng-deep tr.mat-footer-row, tr.mat-row {\r\n    height: 48px;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-right: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-top: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\nth.mat-header-cell.cdk-column-Before.mat-column-Before {\r\n    width: 24%;\r\n    width: 25%;\r\n    text-align: center;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-right: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-top: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\nth.mat-header-cell.cdk-column-After.mat-column-After {\r\n    width: 25%;\r\n    text-align: center;\r\n    width: 25%;\r\n    text-align: center;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-right: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-top: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\nth.mat-header-cell.cdk-column-Limit_range.mat-column-Limit_range {\r\n    width: 25%;\r\n    text-align: center;\r\n    width: 25%;\r\n    text-align: center;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-right: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-top: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\n::ng-deep td.mat-cell:first-of-type, td.mat-footer-cell:first-of-type, th.mat-header-cell:first-of-type {\r\n    padding-left: 24px;\r\n    /* border-right: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\ntr.mat-header-row {\r\n    height: 56px;\r\n    border-bottom: 1px solid rgba(201, 191, 191, 0.788235294117647) !important;\r\n    width: 25%;\r\n    text-align: center;\r\n    /* border-left: 1px solid rgba(201, 191, 191, 0.788235294117647);\r\n    border-right: 1px solid rgba(201, 191, 191, 0.788235294117647); */\r\n}\r\n\r\nimg.good {\r\n    width: 60%;\r\n}\r\n\r\nhtml {\r\n    -webkit-text-size-adjust: none\r\n  }\r\n\r\n/* table{\r\n    width: 100%; \r\n    word-wrap:break-word;\r\n    table-layout: fixed;\r\n} */\r\n\r\n/* ----------- Non-Retina Screens ----------- */\r\n\r\n@media screen \r\n  and (min-width: 1200px) \r\n  and (max-width: 1600px)  { \r\n/* start */\r\nimg.good {\r\n    width: 60%;\r\n}\r\n::ng-deep .mat-form-field-infix {\r\n    display: block;\r\n    position: relative;\r\n    -webkit-box-flex: 1;\r\n            flex: auto;\r\n    min-width: 0;\r\n    /* top: 10px; */\r\n    width: 180px;\r\n    left: 20px;\r\n    /* background: white; */\r\n    line-height: 2.5;\r\n}\r\nlabel {\r\n  display: inline-block;\r\n  max-width: 100%;\r\n  margin-bottom: 5px;\r\n  font-weight: 700;\r\n  /* color: white; */\r\n  background: bottom;\r\n  margin-top: 19px;\r\n  line-height: 2.5;\r\n  margin-left: 20px;\r\n  /* width: 180px; */\r\n}\r\nselect{\r\n  background:#003955;\r\n  border:1px solid #003955;\r\n  color:white\r\n}\r\n\r\n\r\n.mat-toolbar {\r\n  background: white;\r\n  color: rgba(0, 0, 0, 0.87);\r\n}\r\n\r\n\r\n.fa, .fab, .fal, .far, .fas {\r\n  -moz-osx-font-smoothing: grayscale;\r\n  -webkit-font-smoothing: antialiased;\r\n  /* display: inline-block; */\r\n  font-style: normal;\r\n  font-variant: normal;\r\n  text-rendering: auto;\r\n  font-size: 27px;\r\n  line-height: 1.9;\r\n  color: white;\r\n  margin-right:10px;\r\n}\r\n\r\n.top_icons {\r\n/* width:50% !important; */\r\n}\r\n.center{\r\ntext-align: center;\r\nposition: absolute;\r\ntop: 0;\r\nleft: 40%;\r\nline-height: 0.7;\r\ncolor: white;\r\nfont-size: 15px !important;\r\n}\r\nselect.classic {\r\n   /* top: 32px; */\r\n   background-image: linear-gradient(45deg, transparent 50%, #e8e8f1 50%), linear-gradient(135deg, #ededf3 50%, transparent 50%), linear-gradient(to right, #222324, #2f3030);\r\n   background-position: calc(100% - 23px) calc(1em + 2px), calc(100% - 15px) calc(1em + 2px), 100% 47px;\r\n   background-size: 8px 8px, 8px 8px, 2.8em 2.8em;\r\n   background-repeat: no-repeat;  \r\n}\r\n\r\nselect.mat-input-element {\r\n  font: normal !;\r\n    -moz-appearance: none;\r\n    -webkit-appearance: none;\r\n    position: relative;\r\n    background-color: #003955;\r\n    color: white;\r\n    display: -webkit-inline-box;\r\n    display: inline-flex;\r\n    box-sizing: border-box;\r\n    /* font-size: 19px; */\r\n    padding-top: 7px !important;\r\n    /* padding-top: 1em; */\r\n    top: -1em;\r\n    margin-bottom: -1em;\r\n}\r\n.h1, .h2, .h3, .h4, .h5, .h6, h1, h2, h3, h4, h5, h6 {\r\n  font-family: inherit;\r\n  font-weight: 500;\r\n  /* line-height: 0.4; */\r\n  color: inherit;\r\n}\r\nheader {\r\n    height: 58px;\r\n    width: 100%;\r\n    background-color: #003955;\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n}\r\n.mat-toolbar-row, .mat-toolbar-single-row {\r\n  /* height: 226px; */\r\n  /* margin-bottom: -35px; */\r\n}\r\n\r\n.left {\r\n    width: 50%;\r\n}\r\n.right {\r\n    width: 48%;\r\n}\r\n\r\n  \r\n  .topnav {\r\n    overflow: hidden;\r\n  \r\n  }\r\n  \r\n  .topnav a {\r\n    float: left;\r\n    display: block;\r\n    color: #333 !important;\r\n    text-align: center;\r\n    padding: 14px 20px;\r\n    text-decoration: none;\r\n    font-size: 21px;\r\n  }\r\n  \r\n  .topnav a:hover {\r\n    background-color: #ddd;\r\n    color: black;\r\n  }\r\n  \r\n  .topnav a.active {\r\n    background-color: white;\r\n    color: black;\r\n  }\r\n  \r\n  .topnav .icon {\r\n    display: none;\r\n  }\r\n/* end */\r\n    .show111{\r\n        display:none;\r\n    }\r\n    \r\n    app-topbar {\r\n        display: block;\r\n    }\r\n    .margin_top{\r\n\r\n        margin-top:11px;\r\n    \r\n    }\r\n    ::ng-deep .row{\r\n        margin:0px;\r\n    }\r\n    .image{\r\n    background-image: url('bg.png');\r\n    background-repeat: no-repeat;\r\n    /* height: 525px; */\r\n    height: 524px;\r\n    background-position: center 0;\r\n\r\n    \r\n    }\r\n    .margin_top h1{\r\n        /* font-size: 35px; */\r\n        font-family: Ubuntu;\r\n        font-weight: 600;    \r\n        font-size:36px;\r\n        /* text-align: center; */\r\n            color:#003955;\r\n            margin-left: 177px;\r\n    }\r\n    .margin_top h2{\r\n        font-size: 25px;\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n        color: #003955;\r\n        margin-bottom: 26px;\r\n        margin-top: -5px;\r\n        margin-left: 177px;\r\n    }\r\n    \r\n\r\n    .view{\r\n        margin-top:10px;\r\n        font-size:20px;\r\n        /* text-decoration: underline;\r\n         */\r\n         text-decoration: underline;\r\n    }\r\n    \r\n    .name{\r\n        font-size: 21px;\r\n        color: teal;\r\n        text-transform: uppercase;\r\n    }\r\n    .background{\r\n        background-color: #e6f7f7;\r\n        height: auto;\r\n        width: 147px;\r\n        /* background-position: center; */\r\n        margin: auto;\r\n    }\r\n\r\n    .paragraph{\r\n        color: #003955;\r\n        font-size: 15px;\r\n        font-family: Ubuntu;\r\n    }\r\n    .col-md-12.margin_bottom {\r\n        margin-top: 64px;\r\n    }\r\n    \r\n    a:focus, a:hover {\r\n        color: #134061;\r\n        text-decoration: underline;\r\n        color:teal;\r\n    }\r\n    a {\r\n        color: #134061;\r\n        text-decoration: none;\r\n        cursor: pointer;\r\n    }\r\n    .inside .para{\r\n        font-size: 30px;\r\n        color: #21365a;\r\n        margin-bottom: 20px;\r\n        margin-top: 13px;\r\n        font-family: Ubuntu;\r\n    \r\n    \r\n    }\r\n    .style{\r\n        font-size: 33px;\r\n        font-family: Ubuntu;\r\n        color: #003955;\r\n        /* margin-top: 62px; */\r\n    }\r\n    .subheading{\r\n        font-size: 22px;\r\n        color: #003955;\r\n        font-family: Ubuntu;\r\n        margin-top: 20px;\r\n    }\r\n    \r\n    table {\r\n        margin-top:10px;\r\n        width: 100%;\r\n        box-shadow:none;\r\n        text-align:left;\r\n    }  \r\n    \r\n    ::ng-deep mat-row, td.mat-cell {\r\n        border-top-color: #00808085;\r\n        font-size: 16px;\r\n        line-height: 2.7;\r\n        font-family: Ubuntu;\r\n        color: #2b5d6f;\r\n        text-align: center;\r\n        /* border-top: 1px solid red; */\r\n    }\r\n    ::ng-deep td.mat-cell, td.mat-footer-cell, th.mat-header-cell {\r\n        padding: 0;\r\n        /* padding: 0; */\r\n        border-bottom-width: 0px;\r\n        border-bottom-style: solid;\r\n        text-align: center;\r\n    }\r\n\r\n    mat-header-row, mat-footer-row , th.mat-header-cell, td.mat-footer-cell{\r\n        border-bottom-color: white;\r\n        font-size: 18px;\r\n        line-height: 2.7;\r\n        font-family: Ubuntu;\r\n        text-align: center;\r\n    }\r\n    \r\n    .mat-header-cell {\r\n        color: #d0c9d6;\r\n        font-family: Ubuntu;\r\n        text-align: center;   \r\n    }\r\n    \r\n    \r\n    .button_reset{\r\n        color: white;\r\n        height:64px;\r\n        font-size:20px;\r\n        width:354px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 80px;\r\n        margin-bottom: 100px;\r\n        outline: none;\r\n    }\r\n    \r\n    td.header_title.mat-cell.cdk-column-Substance.mat-column-Substance.ng-star-inserted{\r\n    \r\n        font-size: 20px;\r\n        font-weight: bold;\r\n        font-family: Ubuntu;\r\n    }\r\n}\r\n\r\n/* ----------- Retina Screens ----------- */\r\n\r\n/* ----------- iPhone 4 and 4S ----------- */\r\n\r\n/* ----------- iPhone 5, 5S, 5C and 5SE ----------- */\r\n\r\n/* Portrait and Landscape */\r\n\r\n@media only screen and (max-width: 600px)\r\n {\r\n\r\n\r\n\r\n    tr.mat-header-row {\r\n        height: 56px;\r\n        border-bottom: 1px solid #80808042 !important;\r\n    }\r\n    td.mat-cell:last-of-type, td.mat-footer-cell:last-of-type, th.mat-header-cell:last-of-type {\r\n        padding-right: 0px;\r\n    }\r\n    .col-lg-1, .col-lg-10, .col-lg-11, .col-lg-12, .col-lg-2, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6, .col-lg-7, .col-lg-8, .col-lg-9, .col-md-1, .col-md-10, .col-md-11, .col-md-12, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, .col-md-7, .col-md-8, .col-md-9, .col-sm-1, .col-sm-10, .col-sm-11, .col-sm-12, .col-sm-2, .col-sm-3, .col-sm-4, .col-sm-5, .col-sm-6, .col-sm-7, .col-sm-8, .col-sm-9, .col-xs-1, .col-xs-10, .col-xs-11, .col-xs-12, .col-xs-2, .col-xs-3, .col-xs-4, .col-xs-5, .col-xs-6, .col-xs-7, .col-xs-8, .col-xs-9 {\r\n        position: relative;\r\n        min-height: 1px;\r\n        padding-right: 0px;\r\n        padding-left: 0px;\r\n    }\r\n    .app-topbar {\r\n        display: none;\r\n    }\r\n    .show112{\r\n        display:none;\r\n    }\r\n    .margin_top{\r\n\r\n        margin-top: 109px;\r\n    \r\n    }\r\n    ::ng-deep .row{\r\n        margin:0px;\r\n    }\r\n    ::ng-deep.col-xs-12 {\r\n        width: auto;\r\n    }\r\n\r\n\r\n    .imagefull_mobile{\r\n    background-image: url('change.png');\r\n    background-repeat: no-repeat;    \r\n    background-size: cover;  \r\n    width: 100%;\r\n    height: 240px;   \r\n    \r\n    }\r\n    .margin_top h1{\r\n        /* font-size: 35px; */\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n    \r\n        font-size:29px;\r\n        /* text-align: center; */\r\n            color:#003955;\r\n    \r\n    }\r\n    .view22{\r\nmargin-left:10%;\r\nfont-size:14px;\r\n/* text-decoration: underline;\r\n */\r\n text-decoration: underline;\r\n    }\r\n    .margin_top h2{\r\n        font-size: 20px;\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n        color: #003955;\r\n        margin-bottom: 26px;\r\n        margin-top: 0px;\r\n    }\r\n    p.name.show111 {\r\n        /* margin-top: 40px; */\r\n    }\r\n    p.name.show111 {\r\n        font-size: 20px;\r\n    }\r\n    a.changes_view {\r\n        margin-left: 12%;\r\n        /* margin-top: 42px; */\r\n    }\r\n    .background.safe {\r\n        background-color: #e6f7f7;\r\n        height: 217;\r\n        height: 218px;\r\n        width: 100% !important;\r\n        float: right;\r\n    }\r\n    .container-fluid {\r\n        padding-right: 2%;\r\n        padding-left: 2%;\r\n        margin-right: auto;\r\n        margin-left: auto;\r\n    }\r\n    .background.safe p{\r\n        font-size: 11px;\r\n        margin-left: 19px;\r\n        color: #003955;\r\n       font-family: Ubuntu;\r\n        margin-right: 19px;\r\n    }\r\n    \r\n    .background img {\r\n        /* height: 217px;\r\n        width: 214px;\r\n        padding: 20px; */\r\n        padding: 7%;\r\n        height: 171px;\r\n    \r\n    }\r\n    .view{\r\n        margin-top:15px;\r\n        font-size:14px;\r\n        /* margin-left: 3%; */\r\n        /* text-decoration: underline;\r\n         */\r\n         text-decoration: underline;\r\n    }\r\n    .p_a{\r\n        margin: 0 0 9px 33px;\r\n        width: 100%;\r\n    }\r\n    \r\n    .name{\r\n        font-size: 20px;\r\n        color: teal;\r\n        text-transform: uppercase;\r\n    }\r\n    .background_change1{\r\n        /* background-color: #e6f7f7; */\r\n        background-color: #e6f7f7;\r\n        /* height: 217; */\r\n        height: 174px;\r\n        width: 94%;\r\n        float: left;\r\n    }\r\n\r\n    p.name.name1 {\r\n        margin-top: 14px;\r\n    }\r\n\r\n    p.name.name2 {\r\n        margin-top: 14px;\r\n    }\r\n    .background_change2{\r\n        /* background-color: #e6f7f7; */\r\n        background-color: #e6f7f7;\r\n        /* height: 217; */\r\n        height: 174px;\r\n        width: 94%;\r\n        float: right;\r\n    }\r\n    .row.inside {\r\n        /* margin-left: 4%; */\r\n        /* margin-right:0px; */\r\n    }\r\n    .paragraph{\r\n        color: #003955;\r\n        font-size: 14pt;\r\n        font-family: Ubuntu;\r\n    }\r\n    .col-md-12.margin_bottom {\r\n        margin-top: 64px;\r\n    }\r\n    \r\n    a:focus, a:hover {\r\n        color: #134061;\r\n        text-decoration: underline;\r\n    }\r\n    a {\r\n        color: #134061;\r\n        text-decoration: none;\r\n    }\r\n    .inside .para{\r\n        font-size: 34px;\r\n        color: #21365a;\r\n        margin-bottom: 47px;\r\n        margin-top: 38px;\r\n    \r\n    }\r\n.style{\r\n    font-size: 22px;\r\n    font-family: Ubuntu;\r\n    color: #003955;\r\n    margin-top: 48px;\r\n}\r\n.subheading{\r\n    font-size: 17px;\r\n    color: #003955;\r\n    font-family: Ubuntu;\r\n    margin-top: 20px;\r\n}\r\n    \r\n    table {\r\n        margin-top: 28px;\r\n        /* width: max-content; */\r\n        width:100%;\r\n        box-shadow: none;\r\n        text-align: left;\r\n        border-top: 1px solid #7676763d;\r\n    }  \r\n    \r\n    /* td.mat-cell, td.mat-footer-cell, th.mat-header-cell {\r\n        padding: 0;\r\n        border-bottom-width: 1px;\r\n        border-bottom-style: solid;\r\n        padding: 4px;\r\n    } */\r\n    mat-row, td.mat-cell {\r\n        border-bottom-color: #00808085;\r\n        font-size: 11px;\r\n        line-height: 1.2;\r\n        font-family: Ubuntu;\r\n        color: #2b5d6f;\r\n        text-align: center;\r\n        border-right: 1px solid #7676763d;\r\n    }\r\n    td.mat-cell:first-of-type, td.mat-footer-cell:first-of-type, th.mat-header-cell:first-of-type {\r\n        padding-left: 0px;\r\n        border-right: 1px solid #7676763d;\r\n        border-left: 1px solid #7676763d;\r\n    }\r\n    mat-header-row, mat-footer-row , th.mat-header-cell, td.mat-footer-cell{\r\n        /* border-bottom-color: white; */\r\n        font-size: 14px;\r\n        line-height: 1.2;\r\n        font-family: Ubuntu;\r\n    }\r\n    \r\n    .mat-header-cell {\r\n        color: #d0c9d6;\r\n        font-family: Ubuntu;\r\n        border-right: 1px solid #7676763d\r\n    }\r\n    \r\n    .button_reset{\r\n        color: white;\r\n        /* height:64px; */\r\n        font-size:20px;\r\n        height: 54px;\r\n        width: 266px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 15px;\r\n        margin-bottom: 30%;\r\n    \r\n    }\r\n    input::-webkit-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-moz-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-ms-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::placeholder {\r\n        overflow: visible;\r\n      }\r\n    \r\n\r\n\r\n}\r\n\r\n@media (min-width: 768px) and (max-width: 1024px) {\r\n    tr.mat-header-row {\r\n        height: 56px;\r\n        border-bottom: 1px solid #80808042 !important;\r\n    }\r\n    td.mat-cell:last-of-type, td.mat-footer-cell:last-of-type, th.mat-header-cell:last-of-type {\r\n        padding-right: 0px;\r\n    }\r\n    .col-lg-1, .col-lg-10, .col-lg-11, .col-lg-12, .col-lg-2, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6, .col-lg-7, .col-lg-8, .col-lg-9, .col-md-1, .col-md-10, .col-md-11, .col-md-12, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, .col-md-7, .col-md-8, .col-md-9, .col-sm-1, .col-sm-10, .col-sm-11, .col-sm-12, .col-sm-2, .col-sm-3, .col-sm-4, .col-sm-5, .col-sm-6, .col-sm-7, .col-sm-8, .col-sm-9, .col-xs-1, .col-xs-10, .col-xs-11, .col-xs-12, .col-xs-2, .col-xs-3, .col-xs-4, .col-xs-5, .col-xs-6, .col-xs-7, .col-xs-8, .col-xs-9 {\r\n        position: relative;\r\n        min-height: 1px;\r\n        padding-right: 0px;\r\n        padding-left: 0px;\r\n    }\r\n    .app-topbar {\r\n        display: none;\r\n    }\r\n    .show112{\r\n        display:none;\r\n    }\r\n    .margin_top{\r\n\r\n        margin-top: 109px;\r\n    \r\n    }\r\n    ::ng-deep .row{\r\n        margin:0px;\r\n    }\r\n    ::ng-deep.col-xs-12 {\r\n        width: auto;\r\n    }\r\n\r\n\r\n    .imagefull_mobile{\r\n    background-image: url('change.png');\r\n    background-repeat: no-repeat;    \r\n    background-size: cover;  \r\n    width: 96%;\r\n    height: 240px;   \r\n    \r\n    }\r\n    .margin_top h1{\r\n        /* font-size: 35px; */\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n    \r\n        font-size:29px;\r\n        /* text-align: center; */\r\n            color:#003955;\r\n    \r\n    }\r\n    .margin_top h2{\r\n        font-size: 20px;\r\n        font-family: Ubuntu;\r\n        font-weight: 600;\r\n        color: #003955;\r\n        margin-bottom: 26px;\r\n        margin-top: 0px;\r\n    }\r\n    p.name.show111 {\r\n        /* margin-top: 40px; */\r\n    }\r\n    p.name.show111 {\r\n        font-size: 20px;\r\n    }\r\n    a.changes_view {\r\n        margin-left: 111px;\r\n        /* margin-top: 42px; */\r\n    }\r\n    .background.safe {\r\n        background-color: #e6f7f7;\r\n        height: 284px;\r\n        width: 708px !important;\r\n        float: right;\r\n    }\r\n    .container-fluid {\r\n        padding-right: 2%;\r\n        padding-left: 2%;\r\n        margin-right: auto;\r\n        margin-left: auto;\r\n    }\r\n    .background.safe p{\r\n        font-size: 13px;\r\n        margin-left: 19px;\r\n        color: #003955;\r\n        font-family: serif;\r\n        margin-right: 19px;\r\n    }\r\n    \r\n    .background img {\r\n        /* height: 217px;\r\n        width: 214px;\r\n        padding: 20px; */\r\n        padding: 3%;\r\n        height: 239px;\r\n    \r\n    }\r\n    .view{\r\n        margin-top:15px;\r\n        font-size:14px;\r\n         text-decoration: underline;\r\n         margin-left: 88px;\r\n    }\r\n    \r\n    .view22{\r\n        margin-top:15px;\r\n        font-size:14px;\r\n        /* text-decoration: underline;\r\n         */\r\n         text-decoration: underline;\r\n         margin-left: 175px;\r\n         padding-left:40px;\r\n    }\r\n    .name{\r\n        font-size: 20px;\r\n        color: teal;\r\n        text-transform: uppercase;\r\n    }\r\n    .background_change1{\r\n        /* background-color: #e6f7f7; */\r\n        background-color: #e6f7f7;\r\n        /* height: 217; */\r\n        height: 260px;\r\n        width: 94%;\r\n        float: left;\r\n    }\r\n\r\n    p.name.name1 {\r\n        margin-top: 14px;\r\n    }\r\n\r\n    p.name.name2 {\r\n        margin-top: 14px;\r\n    }\r\n    .background_change2{\r\n        /* background-color: #e6f7f7; */\r\n        background-color: #e6f7f7;\r\n        /* height: 217; */\r\n        height: 260px;\r\n        width: 94%;\r\n        float: right;\r\n    }\r\n    .row.inside {\r\n        /* margin-left: 4%; */\r\n        /* margin-right:0px; */\r\n    }\r\n    .paragraph{\r\n        color: #003955;\r\n        font-size: 14pt;\r\n        font-family: Ubuntu;\r\n    }\r\n    .col-md-12.margin_bottom {\r\n        margin-top: 64px;\r\n    }\r\n    \r\n    a:focus, a:hover {\r\n        color: #134061;\r\n        text-decoration: underline;\r\n    }\r\n    a {\r\n        color: #134061;\r\n        text-decoration: none;\r\n    }\r\n    .inside .para{\r\n        font-size: 34px;\r\n        color: #21365a;\r\n        margin-bottom: 47px;\r\n        margin-top: 38px;\r\n    \r\n    }\r\n    .style{\r\n        font-size: 33px;\r\n        font-family: Ubuntu;\r\n        color: #003955;\r\n        margin-top: 62px;\r\n    }\r\n    .subheading{\r\n        font-size: 22px;\r\n        color: #003955;\r\n        font-family: Ubuntu;\r\n        margin-top: 20px;\r\n    }\r\n    \r\n    table {\r\n        margin-top: 28px;\r\n        /* width: max-content; */\r\n        width:100%;\r\n        box-shadow: none;\r\n        text-align: left;\r\n        border-top: 1px solid #7676763d;\r\n    }  \r\n    \r\n    /* td.mat-cell, td.mat-footer-cell, th.mat-header-cell {\r\n        padding: 0;\r\n        border-bottom-width: 1px;\r\n        border-bottom-style: solid;\r\n        padding: 4px;\r\n    } */\r\n    mat-row, td.mat-cell {\r\n        border-bottom-color: #00808085;\r\n        font-size: 11px;\r\n        line-height: 1.2;\r\n        font-family: Ubuntu;\r\n        color: #2b5d6f;\r\n        text-align: center;\r\n        border-right: 1px solid #7676763d;\r\n    }\r\n    td.mat-cell:first-of-type, td.mat-footer-cell:first-of-type, th.mat-header-cell:first-of-type {\r\n        padding-left: 0px;\r\n        border-right: 1px solid #7676763d;\r\n        border-left: 1px solid #7676763d;\r\n    }\r\n    mat-header-row, mat-footer-row , th.mat-header-cell, td.mat-footer-cell{\r\n        /* border-bottom-color: white; */\r\n        font-size: 14px;\r\n        line-height: 1.2;\r\n        font-family: Ubuntu;\r\n    }\r\n    \r\n    .mat-header-cell {\r\n        color: #d0c9d6;\r\n        font-family: Ubuntu;\r\n        border-right: 1px solid #7676763d\r\n    }\r\n    \r\n    .button_reset{\r\n        color: white;\r\n        /* height:64px; */\r\n        font-size:20px;\r\n        height: 54px;\r\n        width: 266px;\r\n        background: teal;\r\n        border-radius: 30px;\r\n        border: 2px solid teal;\r\n        margin-top: 15px;\r\n    \r\n    }\r\n    input::-webkit-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-moz-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::-ms-input-placeholder {\r\n        overflow: visible;\r\n      }\r\n    input::placeholder {\r\n        overflow: visible;\r\n      }\r\n    \r\n\r\n}\r\n\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(ReportComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.translate.addLangs(['English', 'Spanish', 'Italian']); // console.log(sessionStorage.getItem("pageTitle")=='Spanish' ||  sessionStorage.getItem("pageTitle")=='English' ||sessionStorage.getItem("pageTitle")=='Italian')

          if (sessionStorage.getItem("pageTitle") == 'Spanish' || sessionStorage.getItem("pageTitle") == 'English' || sessionStorage.getItem("pageTitle") == 'Italian') {
            var lang = sessionStorage.getItem("pageTitle");
            this.translate.use(lang); // console.log("1");
          } else {
            this.translate.addLangs(['English', 'Spanish', 'Italian']);
            this.translate.setDefaultLang('English');
            var browserLang = this.translate.getBrowserLang();
            this.translate.use(browserLang.match(/English|Spanish/) ? browserLang : 'English'); // console.log("2");
          }
        ...
        value: function calculation() {
          ...
          var metals = this.apiservices.postdata("metals_data_view_priority", this.data);
          var select_details = this.apiservices.postdata("post_code", this.data);
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(requestArray).subscribe(function (results) {
            _this8.average = results[6]['data']['averageDataRange'];
            console.log(_this8.average); // console.log("here",results);
              ...
              for (var i = 0; i < Object.keys(results[0]).length; i++) {
                if (results[0][i].Substance == 'Free Chlorine') {
                  ...
                  if (results[6]['data']['averageDataRange'] == true) {
                    _this8.Chlorine_value_before_filtering = (results[0][i].minimum + results[0][i].maximum) / 2;

                    if (results[0][i].minimum == 0 && results[0][i].maximum == 0) {
                      results[0][i].Zone = 0;
                    } else {
                  ...
                  if (results[3][i].Filtering == null) {
                    note = 'Normal';
                  } // console.log("this.Chlorine_value_before_filtering",results[0][i].Zone)
                  ...
                  _this8.data_all.push({
                    ...
                    note: note,
                    arange_min: results[0][i].minimum,
                    arange_max: results[0][i].maximum
                  });
                }
              }
            }
            ...
            if (!(results[1] && results[1].constructor === Array && Object.keys(results[1]).length === 0)) {
              for (var _i = 0; _i < Object.keys(results[1]).length; _i++) {
                if (results[1][_i].Substance == 'pH') {
                  results[1][_i].Filtering = parseFloat(results[1][_i].Filtering).toFixed(2);

                  if (results[6]['data']['averageDataRange'] == true) {
                    if (results[1][_i].minimum == 0 && results[1][_i].maximum == 0) {
                      results[1][_i].Zone = 0;
                    } else {
                      results[1][_i].Zone = results[1][_i].minimum + " - " + results[1][_i].maximum; // console.log()
                    }
                  }
                  ...
                  _this8.dataSource.data = _this8.data_all.push({
                    ...
                    note: _note,
                    arange_min: results[1][_i].minimum,
                    arange_max: results[1][_i].maximum
                  });
                }
                ...
                if (results[1][_i].Substance == 'Microplastics') {
                  ...
                  if (results[6]['data']['averageDataRange'] == true) {// results[1][i].Zone=results[1][i].minimum+" - "+results[1][i].maximum;
                  }

                  console.log("results[1][i].Filtering", results[1][_i].Filtering);
                ...
                if (results[1][_i].Substance == 'Hardness') {
                  if (results[6]['data']['averageDataRange'] == true) {
                    results[1][_i].Zone = results[1][_i].minimum + " - " + results[1][_i].maximum;
                    _this8.Hardness_value_before_filtering = (results[1][_i].minimum + results[1][_i].maximum) / 2;
                  }
                  ...
                  if (results[6]['data']['averageDataRange'] != true) {
                    ...
                    if (_this8.Hardness_value_before_filtering == null || isNaN(_this8.Hardness_value_before_filtering)) {
                      _this8.Hardness_value_before_filtering = 0;
                    }
                  }

                  _this8.Hardness = _this8.Hardness_value_before_filtering;
                  console.log("xcxcx", _this8.Hardness);
                  var before_filtering = void 0; // console.log("this.Chlorine_value_before_filtering",this.Chlorine_value_before_filtering)

                  if (_this8.Chlorine_value_before_filtering > 0.5 && _this8.Hardness > 200 || _this8.Chlorine_value_before_filtering > 0.5 && _this8.Hardness < 100) {
                    before_filtering = "Bad";
                  }

                  if (0.4 < _this8.Chlorine_value_before_filtering && _this8.Chlorine_value_before_filtering < 0.6 && 100 < _this8.Hardness && _this8.Hardness < 200 || 0.4 == _this8.Chlorine_value_before_filtering && _this8.Hardness < 100 || _this8.Chlorine_value_before_filtering == 0.5 && _this8.Hardness < 100) {
                    before_filtering = "Ok";
                  }

                  if (0.4 > _this8.Chlorine_value_before_filtering && _this8.Hardness < 100 || 0.4 > _this8.Chlorine_value_before_filtering && _this8.Hardness > 100) {
                    before_filtering = "Good";
                  }

                  if (before_filtering == undefined) {
                    before_filtering = 'Bad';
                  }
            ...
            if (!(results[2] && results[2].constructor === Array && Object.keys(results[2]).length === 0)) {
              for (var _i2 = 0; _i2 < Object.keys(results[2]).length; _i2++) {
                if (results[2][_i2].Substance == "Calcium") {
                  results[2][_i2].Filtering = parseFloat(results[2][_i2].Filtering).toFixed(2);

                  if (results[6]['data']['averageDataRange'] == true) {
                    if (results[2][_i2].minimum == null || isNaN(results[2][_i2].minimum)) {
                      results[2][_i2].minimum = 0;
                      console.log("true....................................");
                    }

                    if (results[2][_i2].maximum == null || isNaN(results[2][_i2].maximum)) {
                      results[2][_i2].maximum = 0;
                    }

                    results[2][_i2].Zone = results[2][_i2].minimum + " - " + results[2][_i2].maximum;
                  }

                  if (isNaN(results[2][_i2].Zone) || results[2][_i2].Zone == null) {
                    results[2][_i2].Zone = 'Low'; // console.log("results[2][i].Zone.........",results[2][i].Zone)
                  }

                  if (!(isNaN(results[2][_i2].Zone) || results[2][_i2].Zone == null)) {
                    if (results[2][_i2].Zone > 180) {
                      results[2][_i2].Zone = "Very high";
                    }

                    if (results[2][_i2].Zone <= 180 && results[2][_i2].Zone >= 121) {
                      results[2][_i2].Zone = "High";
                    }

                    if (results[2][_i2].Zone <= 120 && results[2][_i2].Zone >= 61) {
                      _this8.data_all[_i2].Before = "Medium";
                    }

                    if (results[2][_i2].Zone <= 60) {
                      results[2][_i2].Zone = "Low";
                    }
                  }

                  if (isNaN(results[2][_i2].Filtering) || results[2][_i2].Filtering == null) {
                    results[2][_i2].Filtering = 'Low';
                    console.log("results[2][i].Filtering.........", results[2][_i2].Filtering);
                  }

                  if (!(isNaN(results[2][_i2].Filtering) || results[2][_i2].Filtering == null)) {
                    if (results[2][_i2].Filtering > 180) {
                      results[2][_i2].Filtering = "Very high";
                    }

                    if (results[2][_i2].Filtering <= 180 && results[2][_i2].Filtering >= 121) {
                      results[2][_i2].Filtering = "High";
                    }

                    if (results[2][_i2].Filtering <= 120 && results[2][_i2].Filtering >= 61) {
                      _this8.data_all[_i2].Filtering = "Medium";
                    }

                    if (results[2][_i2].Filtering <= 60) {
                      results[2][_i2].Filtering = "Low";
                    }
                  }
                  ...
                  console.log("results[2][i].Zone", results[2][_i2].Zone);
                  ...
                  _this8.data_all.push({
                    ...
                    note: _note3,
                    arange_min: results[2][_i2].minimum,
                    arange_max: results[2][_i2].maximum
                  });
                }
              }
            }
            ...
            if (!(results[3] && results[3].constructor === Array && Object.keys(results[3]).length === 0)) {
              ...
              for (var _i3 = 0; _i3 < Object.keys(results[3]).length; _i3++) {
                if (results[3][_i3].Substance == 'Nitrates') {
                  results[3][_i3].Filtering = parseFloat(results[3][_i3].Filtering).toFixed(2);

                  if (results[6]['data']['averageDataRange'] == true) {
                    results[3][_i3].Zone = results[3][_i3].minimum + " - " + results[3][_i3].maximum;
                  } else if (isNaN(results[3][_i3].Filtering) || results[3][_i3].Filtering == null) {
                    results[3][_i3].Filtering = 0;
                  }
                  ...
                  _this8.data_all.push({
                    ...
                    note: _note4,
                    arange_min: results[3][_i3].minimum,
                    arange_max: results[3][_i3].maximum
                  });
                }
              }
            }
            ...
            if (!(results[5] && results[5].constructor === Array && Object.keys(results[5]).length === 0)) {
              ...
              _this8.data_all.push({
                ...
                note: 'Below legal limit',
                arange_min: '',
                arange_max: 'Safe level'
              });
            }

            if (!(results[6] && results[6].constructor === Array && Object.keys(results[6]).length === 0)) {
              console.log("result------------", results[6]['data']);
              _this8.data['utlity_enter'] = results[6]['data']['utlity_enter'];
              _this8.data['province'] = results[6]['data']['province'];
              _this8.data['city'] = results[6]['data']['city'][0]['city'];
              _this8.data['country'] = results[6]['data']['country'];
              _this8.data['description'] = results[6]['data']['description'];
              _this8.data['water'] = results[6]['data']['yes'];
              _this8.data['drinkable'] = results[6]['data']['drinkable'], _this8.data['blog_link'] = results[6]['data']['blog_english'], _this8.data['averageDataRange'] = results[6]['data']['averageDataRange'];
            }
            ...
            if (!(results[0] && results[0].constructor === Array && Object.keys(results[0]).length === 0) || !(results[1] && results[1].constructor === Array && Object.keys(results[1]).length === 0) || !(results[2] && results[2].constructor === Array && Object.keys(results[2]).length === 0) || !(results[3] && results[3].constructor === Array && Object.keys(results[3]).length === 0) || !(results[4] && results[4].constructor === Array && Object.keys(results[4]).length === 0) || !(results[5] && results[5].constructor === Array && Object.keys(results[5]).length === 0)) {
              ...
              _this8.data_all[3] = temp; //end 
              //start tast

              var repeat_value = _this8.data_all[0];
              _this8.data_all[0] = _this8.data_all[3];
              _this8.data_all[3] = _this8.data_all[2];
              _this8.data_all[2] = _this8.data_all[1];
              _this8.data_all[1] = repeat_value; //end taste

              _this8.hold_array.data = _this8.data_all;
              console.log("shdgffffffffffffffffffff", _this8.data_all); // return false;

              for (var _i5 = 0; _i5 < _this8.data_all.length; _i5++) {
                if (!_this8.average) {
                  if (!(_this8.data_all[_i5].Substance == 'Taste' || _this8.data_all[_i5].Substance == 'Bacterias/virus' || _this8.data_all[_i5].Substance == 'Heavy Metals')) {
                    _this8.data_all[_i5].After = parseFloat(_this8.data_all[_i5].After);
                  }
                }

                if (_this8.data_all[_i5].Substance == 'Microplastics') {
                  if (_this8.data_all[_i5].Before == null || _this8.data_all[_i5].Before == undefined || _this8.data_all[_i5].Before == '' || _this8.data_all[_i5].After == null || isNaN(_this8.data_all[_i5].After) || isNaN(_this8.data_all[_i5].Before)) {
                    _this8.data_all[_i5].Before = "Unknown";
                    _this8.data_all[_i5].After = 'z';
                    _this8.data_all[_i5].note = 'Unregulated';
                    _this8.data_all[_i5].arange_max = "z";
                ...
                if (_this8.data_all[_i5].Substance == 'Chlorine') {
                  if (_this8.data_all[_i5].Before != undefined) {
                    _this8.Chlorine = parseFloat(_this8.data_all[_i5].Before);
                  } else if (_this8.data_all[_i5].Before == undefined) {
                    _this8.Chlorine = 0;
                  }
                ...
                if (_this8.data_all[_i5].Substance == 'Limescale') {
                  if (_this8.average) {
                    if (_this8.data_all[_i5].arange_max != null || _this8.data_all[_i5].arange_max != 0) {
                      // if(this.data_all[i].Before!=null||! isNaN(this.data_all[i].Before)){
                      _this8.data_all[_i5].arange_max = parseFloat(_this8.data_all[_i5].arange_max) / 2;

                      if (_this8.data_all[_i5].arange_max > 180) {
                        _this8.data_all[_i5].arange_max = "Very high";
                      }

                      if (_this8.data_all[_i5].arange_max <= 180 && _this8.data_all[_i5].arange_max >= 121) {
                        _this8.data_all[_i5].arange_max = "High";
                      }

                      if (_this8.data_all[_i5].arange_max <= 120 && _this8.data_all[_i5].arange_max >= 61) {
                        _this8.data_all[_i5].arange_max = "Medium";
                      }

                      if (_this8.data_all[_i5].arange_max <= 60) {
                        _this8.data_all[_i5].arange_max = "Low";
                      }

                      console.log("here", _this8.data_all[_i5].arange_max); // this.Hardness=this.data_all[i].Before;
                      // }
                    }
                  }
                  ...
                  if (_this8.data_all[_i5].Before != null || _this8.data_all[_i5].After == null) {
                    // if(!this.average){ 
                    if (_this8.data_all[_i5].Before != null || !isNaN(_this8.data_all[_i5].Before)) {
                      _this8.data_all[_i5].Before = parseFloat(_this8.data_all[_i5].Before);

                      if (_this8.Hardness > 330) {
                        _this8.data_all[_i5].Before = "Very high";
                      }

                      if (_this8.Hardness <= 329 && _this8.Hardness >= 150) {
                        _this8.data_all[_i5].Before = "High";
                      }

                      if (_this8.Hardness <= 149 && _this8.Hardness >= 80) {
                        _this8.data_all[_i5].Before = "Medium";
                      }

                      if (_this8.Hardness <= 79) {
                    ...
                    if (_this8.data_all[_i5].After != null || !isNaN(_this8.data_all[_i5].Before)) {
        ...
        key: "check",
        value: function check() {
          this.router.navigate([this.page_router, this.data['basic_details_id'], this.data['postcode']]).then(function () {
        ...
        value: function opennewtap() {
          ...
          if (this.data.blog_link != null) {
            console.log("this.data.blog_link", this.data.blog_link);
